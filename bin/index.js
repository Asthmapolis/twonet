...
console.log("\n");
console.log(
  "This module has several utility functions for common tasks. \n\tnpm run <command> provides access to these."
);
console.log("\n");
console.log("\t(1) Deactivate a list of hubs :");
console.log("\t  npm run local:deactivate <filename> <region> <env>");
console.log("\n");
console.log("\t(2) Find a specific sensor device : ");
console.log("\t  npm run local:find <sensor-id> <sensor-type> <region> <env>");
console.log("\n");
console.log("\t(3) Provision a list of hubs : ");
console.log("\t  npm run local:provision <hub-id> <region> <env>");
...
console.log("\t  npm run local:register <region> <env>");
...
console.log("\t  npm run local:command <hub-id> <mac> <region> <env>");
console.log("\n");
console.log("\t(6) Get the status of a hub");
console.log("\t  npm run local:status <hub-id> <region> <env>");
