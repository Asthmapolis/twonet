...
api.getHub(hub_id, function(err, details) {
  ...
  db_details.software_version =
    hub.currentSoftwareVersion && hub.currentSoftwareVersion[0] ? hub.currentSoftwareVersion[0] : undefined;
  db_details.firmware_version =
    hub.currentFirmwareVersion && hub.currentFirmwareVersion[0] ? hub.currentFirmwareVersion[0] : undefined;
